...
class Dashboard extends Component
{
    ...
    private function buildTiles(): array
    {
        ...
        if ($hasSession && ($user?->hasRole('CASHIER') || $user?->hasRole('ADMIN'))) {
            ...
            $tiles[] = [
                'route' => 'sales',
                'label' => __('dashboard.sales_tile'),
                'description' => __('dashboard.sales_description'),
                'icon' => $this->salesIcon(),
            ...
            $tiles[] = [
                'route' => 'cash-drawer',
                'label' => __('dashboard.cash_drawer_tile'),
                'description' => __('dashboard.cash_drawer_description'),
                'icon' => $this->cashDrawerIcon(),
