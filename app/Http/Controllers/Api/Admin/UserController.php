...
class UserController extends ApiController
{
    ...
    public function update(Request $request, User $user): JsonResponse
    {
        ...
        if (array_key_exists('displayName', $validated)) {
            $update['name'] = $validated['displayName'];
        }
        if (array_key_exists('email', $validated)) {
            $update['email'] = $validated['email'];
        }
        if (array_key_exists('preferredLanguage', $validated)) {
            $update['preferred_language_code'] = $validated['preferredLanguage'];
        }
        if (array_key_exists('theme', $validated)) {
            $update['theme'] = $validated['theme'];
        }
