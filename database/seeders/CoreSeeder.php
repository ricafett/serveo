...
class CoreSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $translations = [
            ...
            ['pt-PT', 'app', 'navigation_label_billing_groups', 'Grupos de faturação'],
            ['pt-PT', 'app', 'model_label_billing_group', 'Grupo de faturação'],
            ['pt-PT', 'app', 'plural_model_label_billing_groups', 'Grupos de faturação'],
            ...
            ['pt-PT', 'billing', 'reopen_error', 'Erro ao reabrir grupo'],
            ...
            ['pt-PT', 'cashier', 'billing_groups', 'Grupos de faturação'],
            ['pt-PT', 'cashier', 'search_placeholder', 'Pesquise por nome, código ou sala...'],
            ['pt-PT', 'cashier', 'no_groups_found', 'Nenhum grupo encontrado.'],
            ...
            ['pt-PT', 'cashier', 'select_group_docs', 'Selecione um grupo para ver documentos imprimíveis.'],
