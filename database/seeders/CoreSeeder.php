...
class CoreSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $translations = [
            ...
            ['pt-PT', 'app', 'pair_sequence', 'Sequência'],
            ['pt-PT', 'app', 'seat_a', 'Lugar A'],
            ['pt-PT', 'app', 'seat_b', 'Lugar B'],
            ['pt-PT', 'app', 'default_server', 'Servidor padrão'],
            ['pt-PT', 'app', 'activate', 'Ativar'],
            ['pt-PT', 'app', 'deactivate', 'Desativar'],
            ['pt-PT', 'app', 'enable_selected', 'Ativar selecionados'],
            ['pt-PT', 'app', 'disable_selected', 'Desativar selecionados'],
            ['pt-PT', 'app', 'enable_selected_vouchers', 'Ativar senhas selecionadas'],
            ['pt-PT', 'app', 'disable_selected_vouchers', 'Desativar senhas selecionadas'],
            ['pt-PT', 'app', 'bulk_menu_item_confirmation', 'Isto vai atualizar :count itens de menu selecionados.'],
            ['pt-PT', 'app', 'seat_already_used', 'O lugar :seat já está atribuído a outro par nesta fila.'],
            ...
            ['pt-PT', 'app', 'model_label_sale', 'Venda'],
            ['pt-PT', 'app', 'plural_model_label_sales', 'Vendas'],
            ...
            ['pt-PT', 'app', 'job_kind_server_order', 'Pedido de servente'],
            ['pt-PT', 'app', 'job_kind_cashier_totals', 'Totais de caixa'],
            ['pt-PT', 'app', 'job_kind_session_totals', 'Totais da sessão'],
            ['pt-PT', 'app', 'job_kind_inventory_movements', 'Movimentos de inventário'],
            ...
            ['pt-PT', 'app', 'document_type_server_order', 'Pedido de servente'],
            ['pt-PT', 'app', 'document_type_cashier_totals', 'Totais de caixa'],
            ['pt-PT', 'app', 'document_type_session_totals', 'Totais da sessão'],
            ['pt-PT', 'app', 'document_type_inventory_movements', 'Movimentos de inventário'],
            ...
            ['pt-PT', 'app', 'source_domain', 'Domínio de origem'],
            ['pt-PT', 'app', 'export_source_all', 'Todos'],
            ['pt-PT', 'app', 'export_source_billing', 'Contas'],
            ['pt-PT', 'app', 'export_source_sales', 'Vendas'],
            ...
            ['pt-PT', 'app', 'ignore_item_notes', 'Ignorar notas dos items'],
            ['pt-PT', 'app', 'helper_text_ignore_item_notes', 'Não imprimir notas dos items neste tipo de documento.'],
            ...
            ['en-US', 'app', 'pair', 'Pair'],
            ['en-US', 'app', 'pair_sequence', 'Sequence'],
            ['en-US', 'app', 'seat_a', 'Seat A'],
            ['en-US', 'app', 'seat_b', 'Seat B'],
            ['en-US', 'app', 'default_server', 'Default Server'],
            ['en-US', 'app', 'activate', 'Activate'],
            ['en-US', 'app', 'deactivate', 'Deactivate'],
            ['en-US', 'app', 'enable_selected', 'Enable selected'],
            ['en-US', 'app', 'disable_selected', 'Disable selected'],
            ['en-US', 'app', 'enable_selected_vouchers', 'Enable selected vouchers'],
            ['en-US', 'app', 'disable_selected_vouchers', 'Disable selected vouchers'],
            ['en-US', 'app', 'bulk_menu_item_confirmation', 'This will update :count selected menu items.'],
            ['en-US', 'app', 'seat_already_used', 'Seat :seat is already assigned to another pair in this row.'],
            ...
            ['en-US', 'app', 'model_label_sale', 'Sale'],
            ['en-US', 'app', 'plural_model_label_sales', 'Sales'],
            ...
            ['en-US', 'app', 'job_kind_server_order', 'Server Order'],
            ['en-US', 'app', 'job_kind_cashier_totals', 'Cashier Totals'],
            ['en-US', 'app', 'job_kind_session_totals', 'Session Totals'],
            ['en-US', 'app', 'job_kind_inventory_movements', 'Inventory Movements'],
            ...
            ['en-US', 'app', 'document_type_server_order', 'Server Order'],
            ['en-US', 'app', 'document_type_cashier_totals', 'Cashier Totals'],
            ['en-US', 'app', 'document_type_session_totals', 'Session Totals'],
            ['en-US', 'app', 'document_type_inventory_movements', 'Inventory Movements'],
            ...
            ['en-US', 'app', 'source_domain', 'Source Domain'],
            ['en-US', 'app', 'export_source_all', 'All'],
            ['en-US', 'app', 'export_source_billing', 'Billing'],
            ['en-US', 'app', 'export_source_sales', 'Sales'],
            ...
            ['en-US', 'app', 'ignore_item_notes', 'Ignore item notes'],
            ['en-US', 'app', 'helper_text_ignore_item_notes', 'Do not print item notes on this document type.'],
            ...
            ['pt-PT', 'order', 'more_submit_actions', 'Mais ações do pedido'],
            ['pt-PT', 'order', 'save_without_production', 'Guardar sem enviar'],
            ['pt-PT', 'order', 'save_without_production_help', 'Guarda este pedido na conta sem imprimir tickets de cozinha ou bar por agora.'],
            ['pt-PT', 'order', 'saved_without_production_success', 'Pedido guardado sem envio para produção.'],
            ['pt-PT', 'order', 'print_server_order', 'Imprimir pedido de servente'],
            ['pt-PT', 'order', 'print_server_order_help', 'Imprime uma cópia de referência completa deste pedido na impressora do caixa quando o submeter.'],
            ...
            ['en-US', 'order', 'more_submit_actions', 'More order actions'],
            ['en-US', 'order', 'save_without_production', 'Save without production'],
            ['en-US', 'order', 'save_without_production_help', 'Keep this order on the billing group without printing kitchen or bar tickets yet.'],
            ['en-US', 'order', 'saved_without_production_success', 'Order saved without sending to production.'],
            ['en-US', 'order', 'print_server_order', 'Print server order'],
            ['en-US', 'order', 'print_server_order_help', 'Print a full reference copy of this order to the cashier printer when you submit it.'],
            ...
            ['pt-PT', 'billing', 'void_item', 'Anular item'],
            ['pt-PT', 'billing', 'void_order', 'Anular pedido'],
            ['pt-PT', 'billing', 'void_reason', 'Motivo da anulação'],
            ['pt-PT', 'billing', 'void_print_warning', 'Será impressa uma anulação no destino original.'],
            ['pt-PT', 'billing', 'void_order_warning', 'Isto anula todos os itens elegíveis restantes do pedido e imprime as respetivas anulações.'],
            ['pt-PT', 'billing', 'confirm_void_item', 'Confirmar anulação do item'],
            ['pt-PT', 'billing', 'confirm_void_order', 'Confirmar anulação do pedido'],
            ...
            ['pt-PT', 'billing', 'void_items', 'Anular itens'],
            ['pt-PT', 'billing', 'confirm_void', 'Confirmar anulação'],
            ['pt-PT', 'billing', 'confirm_void_n_items', 'Anular :count itens'],
            ['pt-PT', 'billing', 'items_voided', 'Itens anulados.'],
            ['pt-PT', 'billing', 'select_items_to_void', 'Selecione os itens a anular.'],
            ['pt-PT', 'billing', 'no_voidable_items', 'Nenhum item disponível para anular.'],
            ['pt-PT', 'billing', 'select_all', 'Selecionar Todos'],
            ['pt-PT', 'billing', 'deselect_all', 'Desmarcar Todos'],
            ['pt-PT', 'billing', 'void_reason_optional', 'Motivo da anulação (opcional)'],
            ['pt-PT', 'billing', 'status_submitted', 'Submetido'],
            ['pt-PT', 'billing', 'status_draft', 'Guardado'],
            ['pt-PT', 'billing', 'status_partially_voided', 'Parcialmente Anulado'],
            ['pt-PT', 'billing', 'status_voided', 'Anulado'],
            ['pt-PT', 'billing', 'submit_saved_order', 'Enviar para produção'],
            ['pt-PT', 'billing', 'saved_order_submitted', 'Pedido guardado enviado para produção.'],
            ['pt-PT', 'billing', 'mark_delivered', 'Marcar como entregue'],
            ['pt-PT', 'billing', 'mark_undelivered', 'Desmarcar entrega'],
            ['pt-PT', 'billing', 'mark_all_delivered', 'Marcar todos como entregues'],
            ['pt-PT', 'billing', 'mark_all_undelivered', 'Desmarcar todas as entregas'],
            ['pt-PT', 'billing', 'delivered', 'Entregue'],
            ['pt-PT', 'billing', 'cannot_void_delivered', 'Não é possível anular um item entregue. Desmarque a entrega primeiro.'],
            ...
            ['en-US', 'billing', 'void_item', 'Void Item'],
            ['en-US', 'billing', 'void_order', 'Void Order'],
            ['en-US', 'billing', 'void_reason', 'Void Reason'],
            ['en-US', 'billing', 'void_print_warning', 'A void slip will be printed to the original destination.'],
            ['en-US', 'billing', 'void_order_warning', 'This voids all remaining eligible items in the order and prints the required void slips.'],
            ['en-US', 'billing', 'confirm_void_item', 'Confirm Void Item'],
            ['en-US', 'billing', 'confirm_void_order', 'Confirm Void Order'],
            ...
            ['en-US', 'billing', 'void_items', 'Void Items'],
            ['en-US', 'billing', 'confirm_void', 'Confirm Void'],
            ['en-US', 'billing', 'confirm_void_n_items', 'Void :count items'],
            ['en-US', 'billing', 'items_voided', 'Items voided.'],
            ['en-US', 'billing', 'select_items_to_void', 'Select items to void.'],
            ['en-US', 'billing', 'no_voidable_items', 'No items available to void.'],
            ['en-US', 'billing', 'select_all', 'Select All'],
            ['en-US', 'billing', 'deselect_all', 'Deselect All'],
            ['en-US', 'billing', 'void_reason_optional', 'Void Reason (optional)'],
            ['en-US', 'billing', 'status_submitted', 'Submitted'],
            ['en-US', 'billing', 'status_draft', 'Saved'],
            ['en-US', 'billing', 'status_partially_voided', 'Partially Voided'],
            ['en-US', 'billing', 'status_voided', 'Voided'],
            ['en-US', 'billing', 'submit_saved_order', 'Send to production'],
            ['en-US', 'billing', 'saved_order_submitted', 'Saved order sent to production.'],
            ['en-US', 'billing', 'mark_delivered', 'Mark delivered'],
            ['en-US', 'billing', 'mark_undelivered', 'Unmark delivered'],
            ['en-US', 'billing', 'mark_all_delivered', 'Mark all delivered'],
            ['en-US', 'billing', 'mark_all_undelivered', 'Unmark all delivered'],
            ['en-US', 'billing', 'delivered', 'Delivered'],
            ['en-US', 'billing', 'cannot_void_delivered', 'Cannot void a delivered item. Unmark as delivered first.'],
            ...
            ['pt-PT', 'dashboard', 'sales_tile', 'Vendas'],
            ...
            ['en-US', 'dashboard', 'sales_tile', 'Sales'],
            ...
            ['pt-PT', 'ticket', 'server_order', 'PEDIDO DE SERVENTE'],
            ...
            ['pt-PT', 'sales', 'menu_tab', 'Menu'],
            ['pt-PT', 'sales', 'cart_tab', 'Venda'],
            ['pt-PT', 'sales', 'cart_title', 'Carrinho da venda'],
            ['pt-PT', 'sales', 'payment_title', 'Pagamento'],
            ['pt-PT', 'sales', 'amount', 'Valor'],
            ['pt-PT', 'sales', 'payment_method', 'Método de pagamento'],
            ['pt-PT', 'sales', 'print_receipt', 'Imprimir talão'],
            ['pt-PT', 'sales', 'pay_and_print', 'Pagar e imprimir senhas'],
            ['pt-PT', 'sales', 'no_items', 'Sem itens de senha nesta categoria.'],
            ['pt-PT', 'sales', 'empty_cart', 'Nenhum item adicionado.'],
            ['pt-PT', 'sales', 'no_session', 'Não existe sessão de serviço aberta.'],
            ['pt-PT', 'sales', 'payment_amount_required', 'O valor do pagamento é obrigatório.'],
            ['pt-PT', 'sales', 'sale_completed', 'Venda :code concluída.'],
            ['pt-PT', 'sales', 'sold_at', 'Vendida em'],
            ['pt-PT', 'sales', 'items', 'Itens'],
            ['pt-PT', 'sales', 'documents', 'Documentos'],
            ['pt-PT', 'sales', 'quantity', 'Quantidade'],

            ['en-US', 'ticket', 'sale', 'Sale'],
            ['en-US', 'ticket', 'voucher', 'VOUCHER'],
            ['en-US', 'ticket', 'sale_receipt', 'SALE RECEIPT'],
            ['en-US', 'ticket', 'server_order', 'SERVER ORDER'],
            ...
            ['en-US', 'sales', 'menu_tab', 'Menu'],
            ['en-US', 'sales', 'cart_tab', 'Cart'],
            ['en-US', 'sales', 'cart_title', 'Sale Cart'],
            ['en-US', 'sales', 'payment_title', 'Payment'],
            ['en-US', 'sales', 'amount', 'Amount'],
            ['en-US', 'sales', 'payment_method', 'Payment Method'],
            ['en-US', 'sales', 'print_receipt', 'Print receipt'],
            ['en-US', 'sales', 'pay_and_print', 'Pay and print vouchers'],
            ['en-US', 'sales', 'no_items', 'No voucher items in this category.'],
            ['en-US', 'sales', 'empty_cart', 'No items added.'],
            ['en-US', 'sales', 'no_session', 'No open service session.'],
            ['en-US', 'sales', 'payment_amount_required', 'Payment amount is required.'],
            ['en-US', 'sales', 'sale_completed', 'Sale :code completed.'],
            ['en-US', 'sales', 'sold_at', 'Sold at'],
            ['en-US', 'sales', 'items', 'Items'],
            ['en-US', 'sales', 'documents', 'Documents'],
            ['en-US', 'sales', 'quantity', 'Quantity'],
            ...
            ['pt-PT', 'order', 'add_note', 'Adicionar nota'],
            ['pt-PT', 'order', 'edit_note', 'Editar nota'],
            ['pt-PT', 'order', 'delete_note', 'Remover nota'],
            ['pt-PT', 'order', 'note_for', 'Nota —'],
            ['pt-PT', 'order', 'item_note_label', 'Nota do item'],
            ['pt-PT', 'order', 'item_note_placeholder', 'ex.: sem cebola, bem passado'],
            ...
            ['en-US', 'order', 'add_note', 'Add note'],
            ['en-US', 'order', 'edit_note', 'Edit note'],
            ['en-US', 'order', 'delete_note', 'Delete note'],
            ['en-US', 'order', 'note_for', 'Note —'],
            ['en-US', 'order', 'item_note_label', 'Item note'],
            ['en-US', 'order', 'item_note_placeholder', 'e.g. no onions, well done'],
            ...
            // Session Totals
            ['pt-PT', 'app', 'navigation_label_session_totals', 'Totais da sessão'],
            ['pt-PT', 'app', 'page_title_session_totals', 'Totais da sessão'],
            ['pt-PT', 'app', 'print_session_totals', 'Imprimir totais da sessão'],
            ['pt-PT', 'app', 'print_inventory_movements', 'Imprimir movimentos de inventário'],
            ['pt-PT', 'app', 'no_printer_assigned', 'Nenhuma impressora atribuída ao seu utilizador. Peça a um admin para a configurar.'],
            ['pt-PT', 'app', 'print_queued', 'Impressão colocada na fila'],
            ['pt-PT', 'app', 'no_open_session', 'Nenhuma sessão de serviço aberta. Abra uma sessão para ver os totais.'],
            ['pt-PT', 'app', 'started_at', 'Iniciada'],
            ['pt-PT', 'app', 'total_cash_in', 'Total de entradas'],
            ['pt-PT', 'app', 'total_cash_out', 'Total de saídas'],
            ['pt-PT', 'app', 'total_bill_payments', 'Total pagamentos de contas'],
            ['pt-PT', 'app', 'total_sale_payments', 'Total pagamentos de vendas'],
            ['pt-PT', 'app', 'net_cash_movement', 'Movimento líquido de caixa'],
            ['pt-PT', 'app', 'total_payments', 'Total de pagamentos'],
            ['pt-PT', 'app', 'overall_balance', 'Saldo geral'],
            ['pt-PT', 'app', 'per_cashier_breakdown', 'Detalhe por caixa'],
            ['pt-PT', 'app', 'bill_payments_column', 'Pag. contas'],
            ['pt-PT', 'app', 'sale_payments_column', 'Pag. vendas'],
            ['pt-PT', 'app', 'net', 'Líquido'],
            ['pt-PT', 'app', 'totals', 'TOTAIS'],
            ['pt-PT', 'app', 'inventory_movements', 'Movimentos de inventário'],
            ['pt-PT', 'app', 'inventory_movements_desc', 'Todos os itens vendidos nesta sessão (agrupados por item + variante, modificadores excluídos)'],
            ['pt-PT', 'app', 'item', 'Item'],
            ['pt-PT', 'app', 'variant', 'Variante'],
            ['pt-PT', 'app', 'quantity_sold', 'Qtd vendida'],
            ['pt-PT', 'app', 'total_units_sold', 'Total de unidades vendidas'],
            ['pt-PT', 'app', 'recent_session_documents', 'Documentos recentes'],
            ['pt-PT', 'app', 'no_documents_yet', 'Nenhum documento impresso ainda'],
            ['pt-PT', 'app', 'no_data', 'Sem dados disponíveis para esta sessão'],
            ['pt-PT', 'app', 'document_type_session_totals', 'Totais da sessão'],
            ['pt-PT', 'app', 'document_type_inventory_movements', 'Movimentos de inventário'],
            ...
            // Session Totals
            ['en-US', 'app', 'navigation_label_session_totals', 'Session Totals'],
            ['en-US', 'app', 'page_title_session_totals', 'Session Totals'],
            ['en-US', 'app', 'print_session_totals', 'Print Session Totals'],
            ['en-US', 'app', 'print_inventory_movements', 'Print Inventory Movements'],
            ['en-US', 'app', 'no_printer_assigned', 'No printer assigned to your user. Ask an admin to configure it.'],
            ['en-US', 'app', 'print_queued', 'Print job queued successfully'],
            ['en-US', 'app', 'no_open_session', 'No open service session. Open a session to see totals.'],
            ['en-US', 'app', 'started_at', 'Started'],
            ['en-US', 'app', 'total_cash_in', 'Total Cash IN'],
            ['en-US', 'app', 'total_cash_out', 'Total Cash OUT'],
            ['en-US', 'app', 'total_bill_payments', 'Total Bill Payments'],
            ['en-US', 'app', 'total_sale_payments', 'Total Sale Payments'],
            ['en-US', 'app', 'net_cash_movement', 'Net Cash Movement'],
            ['en-US', 'app', 'total_payments', 'Total Payments'],
            ['en-US', 'app', 'overall_balance', 'Overall Balance'],
            ['en-US', 'app', 'per_cashier_breakdown', 'Per Cashier Breakdown'],
            ['en-US', 'app', 'bill_payments_column', 'Bill Payments'],
            ['en-US', 'app', 'sale_payments_column', 'Sale Payments'],
            ['en-US', 'app', 'net', 'Net'],
            ['en-US', 'app', 'totals', 'TOTALS'],
            ['en-US', 'app', 'inventory_movements', 'Inventory Movements'],
            ['en-US', 'app', 'inventory_movements_desc', 'All items sold this session (grouped by item + variant, modifiers excluded)'],
            ['en-US', 'app', 'item', 'Item'],
            ['en-US', 'app', 'variant', 'Variant'],
            ['en-US', 'app', 'quantity_sold', 'Qty Sold'],
            ['en-US', 'app', 'total_units_sold', 'Total Units Sold'],
            ['en-US', 'app', 'recent_session_documents', 'Recent Session Documents'],
            ['en-US', 'app', 'no_documents_yet', 'No documents printed yet'],
            ['en-US', 'app', 'no_data', 'No data available for this session'],
            ['en-US', 'app', 'document_type_session_totals', 'Session Totals'],
            ['en-US', 'app', 'document_type_inventory_movements', 'Inventory Movements'],
            ...
            // ticket — session totals
            ['en-US', 'ticket', 'session_totals', 'SESSION TOTALS'],
            ['en-US', 'ticket', 'cashier_breakdown', 'CASHIER BREAKDOWN'],
            ['en-US', 'ticket', 'totals_net', 'Net'],
            ['en-US', 'ticket', 'totals_net_cash', 'Net cash movement'],
            ['en-US', 'ticket', 'totals_overall_balance', 'Overall balance'],
            ['en-US', 'ticket', 'session_summary', 'SESSION SUMMARY'],
            // ticket — inventory movements
            ['en-US', 'ticket', 'inventory_movements', 'INVENTORY MOVEMENTS'],
            ['en-US', 'ticket', 'items_sold_excl_modifiers', 'Items sold (excl. modifiers)'],
            ['en-US', 'ticket', 'total_unique_items', 'Total unique items'],
            ['en-US', 'ticket', 'total_units_sold', 'Total units sold'],
            ...
            // ticket — session totals
            ['pt-PT', 'ticket', 'session_totals', 'TOTAIS DA SESSÃO'],
            ['pt-PT', 'ticket', 'cashier_breakdown', 'DETALHE POR CAIXA'],
            ['pt-PT', 'ticket', 'totals_net', 'Líquido'],
            ['pt-PT', 'ticket', 'totals_net_cash', 'Movimento líquido de caixa'],
            ['pt-PT', 'ticket', 'totals_overall_balance', 'Saldo geral'],
            ['pt-PT', 'ticket', 'session_summary', 'RESUMO DA SESSÃO'],
            // ticket — inventory movements
            ['pt-PT', 'ticket', 'inventory_movements', 'MOVIMENTOS DE INVENTÁRIO'],
            ['pt-PT', 'ticket', 'items_sold_excl_modifiers', 'Itens vendidos (excl. modificadores)'],
            ['pt-PT', 'ticket', 'total_unique_items', 'Total de itens únicos'],
            ['pt-PT', 'ticket', 'total_units_sold', 'Total de unidades vendidas'],
        ];
