...
class CoreSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $translations = [
            ...
            ['pt-PT', 'app', 'is_default_help', 'Apenas um item por conjunto pode ser o pré-definido. Quando o conjunto assume a pré-definição, este item é selecionado automaticamente.'],
            ...
            ['en-US', 'app', 'is_default_help', 'Only one item per set can be the default. When the set assumes default, this item is auto-selected.'],
