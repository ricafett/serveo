<div class="p-4 sm:p-6 lg:p-8" x-data="{ releaseModal: @entangle('showReleaseModal'), voidItemModal: @entangle('showVoidItemModal'), voidOrderModal: @entangle('showVoidOrderModal') }" wire:poll.10s="refreshData">
        ...
        <div class="mb-6 flex flex-wrap gap-2">
            @if(! $group?->is_closed)
                @can('billing_document.create')
                    <button type="button" wire:click="printBill" wire:target="printBill" wire:loading.attr="disabled" class="rounded-lg bg-primary-600 px-4 py-2.5 text-base font-semibold text-white hover:bg-primary-500 min-h-[44px] flex items-center gap-1.5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
