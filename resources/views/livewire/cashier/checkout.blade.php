        ...
        <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-base text-gray-500 dark:text-gray-400">{{ $group?->longLabel() }}</p>
                </div>
            </div>
            @if($group?->is_closed)
        ...
        <div class="mb-6 flex flex-wrap gap-2">
            @if(! $group?->is_closed)
                @can('billing_document.create')
                    <button type="button" wire:click="printBill" class="rounded-lg bg-primary-600 px-4 py-2.5 text-base font-semibold text-white hover:bg-primary-500 min-h-[44px] flex items-center gap-1.5 transition-colors">
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-800">
                    @foreach($group->billingDocuments as $doc)
                        <div class="px-4 py-3 flex items-center justify-between">
                            ...
                            @can('billing_document.reprint')
                                <button type="button" wire:click="reprintBill({{ $doc->id }})" class="text-base text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 px-2 py-1 rounded hover:bg-primary-50 dark:hover:bg-primary-900/20 min-h-[44px]">
                                    {{ __('cashier.reprint') }}
                                </button>
                            @endcan
                        </div>
