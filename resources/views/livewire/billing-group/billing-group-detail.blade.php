                        ...
                        <div class="space-y-1">
                            @foreach($order->items as $item)
                                <div class="flex items-center justify-between text-base">
                                    <div class="flex items-center gap-2">
                                        <span class="{{ $item->voided_at ? 'line-through text-gray-500 dark:text-gray-400' : 'text-gray-900 dark:text-gray-100' }}">
    ...
    <div x-show="voidItemModal" x-cloak class="fixed inset-0 z-50 flex items-end sm:items-center justify-center" style="display: none;">
        ...
        <div x-show="voidItemModal" class="relative w-full sm:w-[28rem] max-w-lg bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl shadow-xl max-h-[90vh] overflow-y-auto">
            <div class="p-4 sm:p-6">
                ...
                <label for="billing-void-item-reason" class="block text-base font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('billing.void_reason_optional') }}</label>
                <textarea id="billing-void-item-reason" wire:model="voidReason" rows="3" placeholder="{{ __('billing.void_reason_optional') }}" class="block w-full rounded-lg border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-base p-3"></textarea>
    ...
    <div x-show="voidOrderModal" x-cloak class="fixed inset-0 z-50 flex items-end sm:items-center justify-center" style="display: none;">
        ...
        <div x-show="voidOrderModal" class="relative w-full sm:w-[28rem] max-w-lg bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl shadow-xl max-h-[90vh] overflow-y-auto">
            <div class="p-4 sm:p-6">
                ...
                <label for="billing-void-order-reason" class="block text-base font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('billing.void_reason_optional') }}</label>
                <textarea id="billing-void-order-reason" wire:model="voidReason" rows="3" placeholder="{{ __('billing.void_reason_optional') }}" class="block w-full rounded-lg border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-base p-3"></textarea>
                @error('voidReason') <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p> @enderror
