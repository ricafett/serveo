<div class="p-4 sm:p-6 lg:p-8">
    <div class="max-w-4xl mx-auto">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Billing Group') }} #{{ $id }}</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Details, orders, and actions.') }}</p>
            </div>
        ...
        <div class="rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-8 text-center">
            <p class="text-sm text-gray-500 dark:text-gray-400">
                {{ __('Billing group detail will be implemented in issue #19. This is the operational layout shell.') }}
            </p>
        </div>
    </div>
</div>
