                    ...
                    <div class="px-4 py-3">
                        <div class="flex items-center justify-between mb-2">
                            <div class="flex items-center gap-2">
                             ...
                             <div class="flex items-center gap-2">
                                @if($order->submission_status === 'DRAFT')
                                    <button
                                        type="button"
                                        wire:click="submitSavedOrder({{ $order->id }})"
                                        wire:target="submitSavedOrder({{ $order->id }})"
                                        wire:loading.attr="disabled"
                                        class="rounded-lg bg-primary-600 px-3 py-2 text-sm font-medium text-white hover:bg-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {{ __('billing.submit_saved_order') }}
                                    </button>
                                @endif
                                ...
                                <span class="text-sm rounded-full px-2 py-0.5 font-medium
                                    {{ $order->submission_status === 'DRAFT' ? 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300' : '' }}
