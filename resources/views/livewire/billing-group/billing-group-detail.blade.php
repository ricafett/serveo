        ...
        <div class="mb-6 flex flex-wrap gap-2">
            @if(! $group?->is_closed)
                ...
                @can('billing_document.create')
                    <button type="button" wire:click="printBill" class="rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 px-4 py-2.5 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 min-h-[44px] flex items-center gap-1.5 transition-colors">
            ...
            @else
                @can('billing_group.reopen')
                    <button type="button" wire:click="reopenGroup" class="rounded-lg bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 px-4 py-2.5 text-base font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 min-h-[44px] flex items-center gap-1.5 transition-colors">
                    ...
                    <div>
                        ...
                        @if($zone->is_open && ! $group?->is_closed)
                            @can('floor.release_zone')
                                <button type="button" wire:click="releaseZone({{ $zone->id }})" wire:confirm="{{ __('billing.release_confirm') }}" class="text-base text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 px-2 py-1 rounded hover:bg-red-50 dark:hover:bg-red-900/20 min-h-[44px]">
