                            ...
                            >
                                ...
                                <div class="mt-1 flex items-center justify-between">
                                    ...
                                    @if(($group->undelivered_order_count ?? 0) > 0)
                                        <span class="inline-flex items-center rounded-full px-2 py-0.5 text-sm font-medium bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400">
                ...
                <form wire:submit.prevent="createBillingGroup" class="space-y-4">
                    ...
                    @if($this->shouldSelectAssignedServer())
                        <div>
                            ...
                            <select id="floor-assigned-server-id" wire:model="assignedServerId" class="block w-full rounded-lg border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-base h-11 px-3">
                    ...
                    <div class="pt-2">
                        <button
                            type="submit"
                            wire:target="createBillingGroup"
